// Student Personal Data Structures
...
function saveDataToStorage() {
    try {
        localStorage.setItem('student_food_data', JSON.stringify(foodData));
        localStorage.setItem('student_transport_data', JSON.stringify(transportData));
    } catch (e) {
...
function loadDataFromStorage() {
    try {
        const f = localStorage.getItem('student_food_data');
        const t = localStorage.getItem('student_transport_data');
        if (f) {
